...
if command_table==1:
    ...
    # file name
    file_name= 'CT_Stark_shift_1_half_to_1_half_loop_3'
    # Open the file
...
HDAWG_filename = ('C:\Codes\HDAWG\Sequences\Stark_shift_1_half_to_1_half_loop_3.txt')
...
awgMod.upload_command_table(device, command_table='CT_Stark_shift_1_half_to_1_half_loop_3')
